...
**Version 2.3.0-dev.5 (2019/09/12)**
...
* **Bugfixes**
	* None.
* **Developer Notes**
	* Added a 'wpsso_json_scripts' filter for WPSSO Core v6.3.0 to add rating meta tags.
...
(2019/09/12) Added a 'wpsso_json_scripts' filter for WPSSO Core v6.3.0 to add rating meta tags.
