...
<p><strong>WPSSO RAR provides Schema <a href="https://schema.org/aggregateRating">aggregateRating</a> using meta tags and (optional) JSON-LD markup</strong> (requires WPSSO JSON Pro extension) &mdash; Google reads the aggregate rating meta tags and/or JSON-LD markup to add rating information to search results!</p>

<p><strong>WPSSO RAR also includes complete Schema <a href="https://schema.org/Review">schema.org/Review</a> details as (optional) JSON-LD markup</strong> (requires WPSSO JSON Pro extension) &mdash; including information about the review (author name, creation time, and excerpt), along with the threaded replies / comments for each review.</p>
...
* [Install the Plugin](https://wpsso.com/codex/plugins/wpsso-ratings-and-reviews/installation/install-the-plugin/)
* [Uninstall the Plugin](https://wpsso.com/codex/plugins/wpsso-ratings-and-reviews/installation/uninstall-the-plugin/)
