...
<p>Star ratings can be enabled/disabled by post type or individual post.</p>

<p>A rating value can be required (or not) before reviews are accepted.</p>

<p>The review form is correctly labeled as a "Review".</p>

<p>The review reply form is correctly labeled as a "Reply".</p>

<p>The color of star ratings can be customized from the settings page.</p>
